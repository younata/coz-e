...
- 2022-08-10 - Glassed forward side of upper forward landing gear bulkhead (the one without hardpoints).
...
- 2022-08-26 - Bevel'd edges of upper forward landing gear bulkhead. Was going to layup the aft side, but ran into an issue with the new revision of the epoxy dispenser board and had to work around it.
